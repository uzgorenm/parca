    ...
    <ScrollView style={styles.root} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.balanceRow}>
          <View>
            <Text style={styles.sectionLabel}>Buying Power</Text>
      ...
      <View style={styles.section}>
          ...
          >
            <View style={styles.holdingLeft}>
              ...
              <View>
                ...
                <Text style={styles.holdingShares}>{holding.shares_owned.toFixed(4)}% Ownership</Text>
        ...
        {(!holdings || holdings.length === 0) && (
          <Text style={styles.emptyText}>No holdings yet. Start trading!</Text>
        )}
      </View>
      ...
      <View style={[styles.section, { marginBottom: 100 }]}>
        <View style={styles.insightCard}>
          ...
          <Text style={styles.insightText}>
            Your real estate portfolio has outpaced the local market average by{' '}
            <Text style={{ fontWeight: '700', color: '#1E3A8A' }}>0.4%</Text> this month.
          </Text>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  depositBtn: { backgroundColor: '#0F172A', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 16 },
  depositBtnText: { color: '#fff', fontWeight: '700', fontSize: 13, textTransform: 'uppercase', letterSpacing: 1 },
  chartContainer: {
    marginTop: 8,
