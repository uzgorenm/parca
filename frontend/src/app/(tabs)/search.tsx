                    ...
                    <ScrollView style={styles.flex} contentContainerStyle={styles.list} showsVerticalScrollIndicator={false}>
                        <View style={styles.listHeader}>
                            <View>
                                ...
                                <Text style={styles.listSubtitle}>Found {properties.length} fractional assets</Text>
                            </View>
                            ...
                            >
                                ...
                                <View style={styles.propertyInfo}>
                                    ...
                                    <View style={styles.propertyStats}>
                                        <View>
                                            <Text style={styles.propertyYield}>4.2% Yield</Text>
                                            <Text style={styles.propertyAvailable}>
                                                {(prop as any).availableShares?.toFixed(2) || '0.00'}% Available
                                            </Text>
                                        </View>
                                        <View style={styles.propertyPriceBlock}>
                                            ...
                                            <Text style={styles.propertyPriceLabel}>MIN SHARE</Text>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    propertyYield: { color: '#1E3A8A', fontWeight: '700', fontSize: 13, textTransform: 'uppercase', letterSpacing: 1 },
