        ...
        <View className="flex-1 bg-white">
          ...
          <View className="flex-1 justify-center px-8">
            <View className="items-center mb-12">
              <Text className="text-5xl font-bold text-primary mb-2">parca</Text>
              <Text className="text-gray-400 font-medium">Fractional Real Estate Trading</Text>
            </View>
            ...
            <View className="bg-gray-50 p-8 rounded-[40px] border border-gray-100 mb-12">
              ...
              <Text className="text-gray-400 text-center leading-6 mb-8">
                Join the future of real estate investing. Start trading fractional shares of premium properties today.
              </Text>
          ...
          {showAuth && (
            ...
            >
              ...
              >
                ...
                <Text className="text-gray-400 mb-8">Choose your preferred login method to continue.</Text>
