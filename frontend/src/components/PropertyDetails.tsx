...
type PropertyDetailsProps = {
    property: {
        ...
        yearOverYearValueChange: string;
        available: string;
        ...
        <View style={styles.root}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.badgeRow}>
                        <View style={styles.badgePrimary}>
                            <Text style={styles.badgePrimaryText}>
                                {parseFloat(property.available).toFixed(2)}% SIMULATED SUPPLY
                            </Text>
                        </View>
                        {userHolding && (
                            <View style={styles.badgeBlue}>
                                <Text style={styles.badgeBlueText}>
                                    {userHolding.positionPercent.toFixed(2)}% SIMULATED POSITION
                                </Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.statsRow}>
                        <View style={styles.statCard}>
                            ...
                            <Text style={styles.statLabel}>Projected Net Return</Text>
                            <Text style={styles.statValue}>{property.projectedNetReturn}</Text>
                        </View>
                        <View style={styles.statCard}>
                            <TrendingUp size={20} color="#1E3A8A" />
                            <Text style={styles.statLabel}>YoY Property Value</Text>
                            <Text style={styles.statValue}>{property.yearOverYearValueChange}</Text>
                        </View>
                    </View>
                    ...
                    {property.bestBid !== undefined && (
                        <View style={styles.priceRow}>
                            <View style={styles.priceItem}>
                                <Text style={styles.priceLabel}>Mock Best Ask (1%)</Text>
                            ...
                            <View style={[styles.priceItem, { alignItems: 'flex-end' }]}>
                                <Text style={styles.priceLabel}>Mock Best Bid (1%)</Text>
            ...
            <View style={styles.actionBar}>
                <View style={styles.actionLeft}>
                    <Text style={styles.actionLabel}>Simulated Price (1%)</Text>
                ...
                <View style={styles.actionButtons}>
                    <TouchableOpacity onPress={onSellPress} style={styles.sellBtn}>
                        <Text style={styles.sellBtnText}>Mock Sell</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={onBuyPress} style={styles.buyBtn}>
                        <Text style={styles.buyBtnText}>Mock Buy</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
